        ...
        <div className="flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 mt-16 lg:mt-6">
            ...
            <div className='text-white flex flex-col gap-7'>
              ...
              <div>
                <p className='text-gray-300 text-center lg:text-left'>Welcome to my Porfolio</p>
              </div>
              <div>
              ...
              <div>
              <Button variant="ghost" className="border-2 m-auto lg:m-0 border-green-500 hover:bg-slate-800 transition-all duration-150 text-base hover:text-white py-6 w-5/6 lg:w-3/6 flex items-center justify-center gap-2">
