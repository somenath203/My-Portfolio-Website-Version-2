...
const Page = () => {
  const socialLinksArray = [
    ...
    },
    {
      ...
      urlOfTheSocialLink:
        "https://stackoverflow.com/users/14437554/somenath-choudhury",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 mt-16 lg:mt-6 px-4">
            <div className="text-white flex flex-col gap-6">
              ...
              <div className="text-gray-400 px-3 lg:p-0 max-w-lg text-center lg:text-left leading-relaxed">
                ...
                building web & mobile apps, training ML/DL models, and shipping
                production-ready AI solutions and APIs.
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center lg:items-start w-full">
                <Link href="/pages/works" className="w-5/6 sm:w-auto">
                  <Button className="border-2 border-green-500 bg-green-500 hover:bg-green-400 transition-all duration-150 text-base text-slate-900 font-semibold py-6 w-full sm:w-auto px-6 flex items-center justify-center gap-2">
                ...
                <Link
                  href="https://drive.google.com/file/d/1VizRj4hqxedNLaFQsaSU4FbXI7hTCRcH/view?usp=sharing"
                  target="_blank"
                    ...
                    <TooltipProvider key={social.id}>
                      <Tooltip>
                        <TooltipTrigger>
                          ...
                          >
                            <i
                              className={`${social.iconOfTheSocialLink} hover:bg-slate-800 cursor-pointer transition-all duration-150 text-3xl lg:text-2xl border-2 text-green-500 border-green-400 p-2 rounded-full`}
                            ></i>
                          </Link>
                        </TooltipTrigger>
                        <TooltipContent>
